...
def create_app(log):
    ...
    @app.route('/')
    def index():
        return render_template('index.html', plate=os.environ.get('PLATE'), id=os.environ.get('PLATE_ID'))
    ...
    def wifi():
        ...
        return render_template("wifi.html", points=points)

    @app.route('/device/<string:plate>/start')
    def start(plate):
        reeturn render_template('start.html')

    @app.route('/device/<string:plate>/stop')
    def stop(plate):
        reeturn render_template('start.html')
